# edit_text version 1.2.0

[![Python](https://img.shields.io/badge/Python-3.6+-yellow?logo=python)](https://python.org)
[![Version](https://img.shields.io/badge/Version-v1.2.0-blue)](https://github.com/uzjhf-836/MyTools_affiliatd---edit_text)
...
python edit_text_v1_2_0.py --help
```
...
```bash
# 反转字符串
python edit_text_v1_2_0.py --text reverse "Hello World"

# 替换文本（普通替换）
python edit_text_v1_2_0.py --text replace "old" "new" "some old text"

# 大小写转换
python edit_text_v1_2_0.py --text case upper "hello world"

# 重复文本 3 遍
python edit_text_v1_2_0.py --text repeat 3 "Ha! "

# 取第 0 到 5 位
python edit_text_v1_2_0.py --text slice 0 5 "Hello World"

# 以空格分割取第 1 段
python edit_text_v1_2_0.py --text at " " 1 "Hello World"
```

### 哈希计算

```bash
python edit_text_v1_2_0.py --hash md5 "hello"
python edit_text_v1_2_0.py --hash sha256 "hello"
python edit_text_v1_2_0.py --hash crc32 "hello"
```

### 编解码

```bash
python edit_text_v1_2_0.py --base64 encode "Hello World"
python edit_text_v1_2_0.py --url encode "https://example.com?a=1&b=2"
python edit_text_v1_2_0.py --morse encode "SOS"
```
...
```bash
# 生成 2048 位密钥对
python edit_text_v1_2_0.py --rsa generate 2048

# 用公钥加密
python edit_text_v1_2_0.py --rsa encrypt public.pem "秘密消息"

# 用私钥解密
python edit_text_v1_2_0.py --rsa decrypt private.pem "<密文>"

# 从私钥提取公钥
python edit_text_v1_2_0.py --rsa pubkey private.pem
```

### 文件工具

```bash
python edit_text_v1_2_0.py --file read input.txt
python edit_text_v1_2_0.py --file hash sha256 input.txt
```
...
```bash
# 摩斯电码 + 反转 + 统计一条龙
$ python edit_text_v1_2_0.py --morse encode "HELLO"
.... . .-.. .-.. ---

$ python edit_text_v1_2_0.py --text reverse ".... . .-.. .-.. ---"
--- ..-. .-.. .- ....

$ python edit_text_v1_2_0.py --stats "文章内容..."
阅读时间: 约 2 分钟 (340 字)
```
...
```
edit_text_v1_2_0.py    # 主程序（单文件，全部功能）
version.txt            # 版本信息
